...
#ifndef _BIFROST_PROTOCOL_FEESCHEDULE_CXX_H_
#define _BIFROST_PROTOCOL_FEESCHEDULE_CXX_H_
...
public:
    ...
    FeeSchedule& wrapForDecode(char* buffer,
                               const std::uint64_t offset,
                               const std::uint64_t actingBlockLength,
                               const std::uint64_t actingVersion,
                               const std::uint64_t bufferLength) {
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t instrumentTypeEncodingOffset() SBE_NOEXCEPT { return 9; }
    ...
    static SBE_CONSTEXPR std::uint16_t makerFeeBpsId() SBE_NOEXCEPT { return 4; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t makerFeeBpsSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool makerFeeBpsInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t makerFeeBpsEncodingOffset() SBE_NOEXCEPT { return 10; }

    static SBE_CONSTEXPR std::int16_t makerFeeBpsNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_INT16; }

    static SBE_CONSTEXPR std::int16_t makerFeeBpsMinValue() SBE_NOEXCEPT { return static_cast<std::int16_t>(-32767); }

    static SBE_CONSTEXPR std::int16_t makerFeeBpsMaxValue() SBE_NOEXCEPT { return static_cast<std::int16_t>(32767); }

    static SBE_CONSTEXPR std::size_t makerFeeBpsEncodingLength() SBE_NOEXCEPT { return 2; }
    ...
    static SBE_CONSTEXPR std::uint16_t takerFeeBpsId() SBE_NOEXCEPT { return 5; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t takerFeeBpsSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool takerFeeBpsInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t takerFeeBpsEncodingOffset() SBE_NOEXCEPT { return 12; }

    static SBE_CONSTEXPR std::int16_t takerFeeBpsNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_INT16; }

    static SBE_CONSTEXPR std::int16_t takerFeeBpsMinValue() SBE_NOEXCEPT { return static_cast<std::int16_t>(-32767); }

    static SBE_CONSTEXPR std::int16_t takerFeeBpsMaxValue() SBE_NOEXCEPT { return static_cast<std::int16_t>(32767); }

    static SBE_CONSTEXPR std::size_t takerFeeBpsEncodingLength() SBE_NOEXCEPT { return 2; }
    ...
    static SBE_CONSTEXPR std::uint16_t updatedTsId() SBE_NOEXCEPT { return 6; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t updatedTsSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool updatedTsInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t updatedTsEncodingOffset() SBE_NOEXCEPT { return 14; }

    static SBE_CONSTEXPR std::uint64_t updatedTsNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT64; }

    static SBE_CONSTEXPR std::uint64_t updatedTsMinValue() SBE_NOEXCEPT { return UINT64_C(0x0); }

    static SBE_CONSTEXPR std::uint64_t updatedTsMaxValue() SBE_NOEXCEPT { return UINT64_C(0xfffffffffffffffe); }

    static SBE_CONSTEXPR std::size_t updatedTsEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const FeeSchedule& _writer) {
        FeeSchedule writer(_writer.m_buffer,
                           _writer.m_offset,
