...
#ifndef _BPT_MESSAGES_ACCOUNTSNAPSHOT_CXX_H_
#define _BPT_MESSAGES_ACCOUNTSNAPSHOT_CXX_H_
...
public:
    ...
    static SBE_CONSTEXPR std::uint16_t totalEquityE8Id() SBE_NOEXCEPT
    {
        return 5;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t totalEquityE8SinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool totalEquityE8InActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t totalEquityE8EncodingOffset() SBE_NOEXCEPT
    {
        return 25;
    }

    static SBE_CONSTEXPR std::int64_t totalEquityE8NullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t totalEquityE8MinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t totalEquityE8MaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t totalEquityE8EncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }
    ...
    #pragma GCC diagnostic pop
        ...
        static SBE_CONSTEXPR std::uint16_t exchangeSymbolId() SBE_NOEXCEPT
        {
            return 1;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t exchangeSymbolSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool exchangeSymbolInActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t exchangeSymbolEncodingOffset() SBE_NOEXCEPT
        {
            return 0;
        }

        static SBE_CONSTEXPR char exchangeSymbolNullValue() SBE_NOEXCEPT
        {
            return static_cast<char>(0);
        }

        static SBE_CONSTEXPR char exchangeSymbolMinValue() SBE_NOEXCEPT
        {
            return static_cast<char>(32);
        }

        static SBE_CONSTEXPR char exchangeSymbolMaxValue() SBE_NOEXCEPT
        {
            return static_cast<char>(126);
        }

        static SBE_CONSTEXPR std::size_t exchangeSymbolEncodingLength() SBE_NOEXCEPT
        {
            return 32;
        }

        static SBE_CONSTEXPR std::uint64_t exchangeSymbolLength() SBE_NOEXCEPT
        {
            return 32;
        }

        SBE_NODISCARD const char *exchangeSymbol() const SBE_NOEXCEPT
        {
            return m_buffer + m_offset + 0;
        }

        SBE_NODISCARD char *exchangeSymbol() SBE_NOEXCEPT
        {
            return m_buffer + m_offset + 0;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t netQtyE8Id() SBE_NOEXCEPT
        {
            return 2;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t netQtyE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool netQtyE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t netQtyE8EncodingOffset() SBE_NOEXCEPT
        {
            return 32;
        }

        static SBE_CONSTEXPR std::int64_t netQtyE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }

        static SBE_CONSTEXPR std::int64_t netQtyE8MinValue() SBE_NOEXCEPT
        {
            return INT64_C(-9223372036854775807);
        }

        static SBE_CONSTEXPR std::int64_t netQtyE8MaxValue() SBE_NOEXCEPT
        {
            return INT64_C(9223372036854775807);
        }

        static SBE_CONSTEXPR std::size_t netQtyE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t avgEntryPriceE8Id() SBE_NOEXCEPT
        {
            return 3;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t avgEntryPriceE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool avgEntryPriceE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t avgEntryPriceE8EncodingOffset() SBE_NOEXCEPT
        {
            return 40;
        }

        static SBE_CONSTEXPR std::int64_t avgEntryPriceE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }
        ...
        static SBE_CONSTEXPR std::size_t avgEntryPriceE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t unrealizedPnlE8Id() SBE_NOEXCEPT
        {
            return 4;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t unrealizedPnlE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool unrealizedPnlE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t unrealizedPnlE8EncodingOffset() SBE_NOEXCEPT
        {
            return 48;
        }

        static SBE_CONSTEXPR std::int64_t unrealizedPnlE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }
        ...
        static SBE_CONSTEXPR std::size_t unrealizedPnlE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
        ...
        friend std::basic_ostream<CharT, Traits> & operator << (
            std::basic_ostream<CharT, Traits> &builder, Positions &writer)
        {
            builder << '{';
...
public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t positionsId() SBE_NOEXCEPT
    {
        return 6;
    }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t positionsSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool positionsInActingVersion() const SBE_NOEXCEPT
    {
        return true;
    }
