...
#pragma GCC diagnostic pop
        ...
        static SBE_CONSTEXPR std::uint64_t sbeBlockLength() SBE_NOEXCEPT { return 24; }
        ...
        static SBE_CONSTEXPR std::uint16_t ccyId() SBE_NOEXCEPT { return 1; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t ccyEncodingOffset() SBE_NOEXCEPT { return 0; }
        ...
        SBE_NODISCARD const char* ccy() const SBE_NOEXCEPT { return m_buffer + m_offset + 0; }

        SBE_NODISCARD char* ccy() SBE_NOEXCEPT { return m_buffer + m_offset + 0; }
        ...
        static SBE_CONSTEXPR std::uint16_t equityE8Id() SBE_NOEXCEPT { return 2; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t equityE8SinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool equityE8InActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t equityE8EncodingOffset() SBE_NOEXCEPT { return 8; }

        static SBE_CONSTEXPR std::int64_t equityE8NullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_INT64; }

        static SBE_CONSTEXPR std::int64_t equityE8MinValue() SBE_NOEXCEPT { return INT64_C(-9223372036854775807); }

        static SBE_CONSTEXPR std::int64_t equityE8MaxValue() SBE_NOEXCEPT { return INT64_C(9223372036854775807); }

        static SBE_CONSTEXPR std::size_t equityE8EncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        SBE_NODISCARD static const char* availableBalanceE8MetaAttribute(const MetaAttribute metaAttribute)
            SBE_NOEXCEPT {
            switch (metaAttribute) {
                case MetaAttribute::PRESENCE:
                    return "required";
        ...
        static SBE_CONSTEXPR std::uint16_t availableBalanceE8Id() SBE_NOEXCEPT { return 3; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t availableBalanceE8SinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool availableBalanceE8InActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t availableBalanceE8EncodingOffset() SBE_NOEXCEPT { return 16; }
...
public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t currencyBalancesId() SBE_NOEXCEPT { return 7; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t currencyBalancesSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool currencyBalancesInActingVersion() const SBE_NOEXCEPT { return true; }
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
        ...
        builder << ", ";
        {
            ...
            writer.currencyBalances().forEach([&](CurrencyBalances& currencyBalances) {
                if (atLeastOne) {
                    builder << ", ";
                }
                atLeastOne = true;
