...
#ifndef _BIFROST_PROTOCOL_BACKTESTACK_CXX_H_
#define _BIFROST_PROTOCOL_BACKTESTACK_CXX_H_
...
public:
    ...
    BacktestAck& wrapForDecode(char* buffer,
                               const std::uint64_t offset,
                               const std::uint64_t actingBlockLength,
                               const std::uint64_t actingVersion,
                               const std::uint64_t bufferLength) {
    ...
    static SBE_CONSTEXPR std::uint16_t tickSeqNumId() SBE_NOEXCEPT { return 1; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t tickSeqNumEncodingOffset() SBE_NOEXCEPT { return 0; }
    ...
    static SBE_CONSTEXPR std::uint16_t simulationTsId() SBE_NOEXCEPT { return 2; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t simulationTsEncodingOffset() SBE_NOEXCEPT { return 8; }
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const BacktestAck& _writer) {
        BacktestAck writer(_writer.m_buffer,
                           _writer.m_offset,
