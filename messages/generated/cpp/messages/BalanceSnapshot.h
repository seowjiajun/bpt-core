...
public:
    ...
    #pragma GCC diagnostic pop
        ...
        static SBE_CONSTEXPR std::uint16_t subAccountId() SBE_NOEXCEPT
        {
            return 2;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t subAccountSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool subAccountInActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t subAccountEncodingOffset() SBE_NOEXCEPT
        {
            return 1;
        }

        static SBE_CONSTEXPR char subAccountNullValue() SBE_NOEXCEPT
        {
            return static_cast<char>(0);
        }

        static SBE_CONSTEXPR char subAccountMinValue() SBE_NOEXCEPT
        {
            return static_cast<char>(32);
        }

        static SBE_CONSTEXPR char subAccountMaxValue() SBE_NOEXCEPT
        {
            return static_cast<char>(126);
        }

        static SBE_CONSTEXPR std::size_t subAccountEncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }

        static SBE_CONSTEXPR std::uint64_t subAccountLength() SBE_NOEXCEPT
        {
            return 8;
        }

        SBE_NODISCARD const char *subAccount() const SBE_NOEXCEPT
        {
            return m_buffer + m_offset + 1;
        }

        SBE_NODISCARD char *subAccount() SBE_NOEXCEPT
        {
            return m_buffer + m_offset + 1;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t totalE8Id() SBE_NOEXCEPT
        {
            return 4;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t totalE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool totalE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t totalE8EncodingOffset() SBE_NOEXCEPT
        {
            return 17;
        }

        static SBE_CONSTEXPR std::int64_t totalE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }

        static SBE_CONSTEXPR std::int64_t totalE8MinValue() SBE_NOEXCEPT
        {
            return INT64_C(-9223372036854775807);
        }

        static SBE_CONSTEXPR std::int64_t totalE8MaxValue() SBE_NOEXCEPT
        {
            return INT64_C(9223372036854775807);
        }

        static SBE_CONSTEXPR std::size_t totalE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t freeE8Id() SBE_NOEXCEPT
        {
            return 5;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t freeE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool freeE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t freeE8EncodingOffset() SBE_NOEXCEPT
        {
            return 25;
        }

        static SBE_CONSTEXPR std::int64_t freeE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }

        static SBE_CONSTEXPR std::int64_t freeE8MinValue() SBE_NOEXCEPT
        {
            return INT64_C(-9223372036854775807);
        }

        static SBE_CONSTEXPR std::int64_t freeE8MaxValue() SBE_NOEXCEPT
        {
            return INT64_C(9223372036854775807);
        }

        static SBE_CONSTEXPR std::size_t freeE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
        ...
        static SBE_CONSTEXPR std::uint16_t holdE8Id() SBE_NOEXCEPT
        {
            return 6;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t holdE8SinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool holdE8InActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t holdE8EncodingOffset() SBE_NOEXCEPT
        {
            return 33;
        }

        static SBE_CONSTEXPR std::int64_t holdE8NullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT64;
        }

        static SBE_CONSTEXPR std::int64_t holdE8MinValue() SBE_NOEXCEPT
        {
            return INT64_C(-9223372036854775807);
        }

        static SBE_CONSTEXPR std::int64_t holdE8MaxValue() SBE_NOEXCEPT
        {
            return INT64_C(9223372036854775807);
        }

        static SBE_CONSTEXPR std::size_t holdE8EncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }
            ...
            std::basic_ostream<CharT, Traits> &builder, Balances &writer)
        {
            ...
            builder << '"' <<
                writer.getSubAccountAsJsonEscapedString().c_str() << '"';
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const BalanceSnapshot &_writer)
{
    BalanceSnapshot writer(
        _writer.m_buffer,
        _writer.m_offset,
