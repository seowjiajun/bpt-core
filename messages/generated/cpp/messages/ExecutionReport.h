...
#ifndef _BIFROST_PROTOCOL_EXECUTIONREPORT_CXX_H_
#define _BIFROST_PROTOCOL_EXECUTIONREPORT_CXX_H_
...
public:
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t feeCurrencyEncodingLength() SBE_NOEXCEPT { return 1; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t timestampNsEncodingOffset() SBE_NOEXCEPT { return 62; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t localTsNsEncodingOffset() SBE_NOEXCEPT { return 70; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t rejectSourceEncodingOffset() SBE_NOEXCEPT { return 78; }
