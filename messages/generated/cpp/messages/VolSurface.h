...
#ifndef _BIFROST_PROTOCOL_VOLSURFACE_CXX_H_
#define _BIFROST_PROTOCOL_VOLSURFACE_CXX_H_
...
public:
    ...
    VolSurface& wrapForDecode(char* buffer,
                              const std::uint64_t offset,
                              const std::uint64_t actingBlockLength,
                              const std::uint64_t actingVersion,
                              const std::uint64_t bufferLength) {
    ...
    static SBE_CONSTEXPR std::uint16_t underlyingId() SBE_NOEXCEPT { return 3; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t underlyingSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool underlyingInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t underlyingEncodingOffset() SBE_NOEXCEPT { return 9; }

    static SBE_CONSTEXPR char underlyingNullValue() SBE_NOEXCEPT { return static_cast<char>(0); }

    static SBE_CONSTEXPR char underlyingMinValue() SBE_NOEXCEPT { return static_cast<char>(32); }

    static SBE_CONSTEXPR char underlyingMaxValue() SBE_NOEXCEPT { return static_cast<char>(126); }

    static SBE_CONSTEXPR std::size_t underlyingEncodingLength() SBE_NOEXCEPT { return 24; }

    static SBE_CONSTEXPR std::uint64_t underlyingLength() SBE_NOEXCEPT { return 24; }

    SBE_NODISCARD const char* underlying() const SBE_NOEXCEPT { return m_buffer + m_offset + 9; }

    SBE_NODISCARD char* underlying() SBE_NOEXCEPT { return m_buffer + m_offset + 9; }
    ...
    static SBE_CONSTEXPR std::uint16_t seqNumId() SBE_NOEXCEPT { return 4; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t seqNumEncodingOffset() SBE_NOEXCEPT { return 33; }
...
#pragma GCC diagnostic pop
        ...
        static SBE_CONSTEXPR std::uint64_t sbeBlockLength() SBE_NOEXCEPT { return 109; }
        ...
        static SBE_CONSTEXPR std::uint16_t expiryDateId() SBE_NOEXCEPT { return 2; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t expiryDateSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool expiryDateInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t expiryDateEncodingOffset() SBE_NOEXCEPT { return 8; }

        static SBE_CONSTEXPR std::uint32_t expiryDateNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT32; }

        static SBE_CONSTEXPR std::uint32_t expiryDateMinValue() SBE_NOEXCEPT { return UINT32_C(0x0); }

        static SBE_CONSTEXPR std::uint32_t expiryDateMaxValue() SBE_NOEXCEPT { return UINT32_C(0xfffffffe); }

        static SBE_CONSTEXPR std::size_t expiryDateEncodingLength() SBE_NOEXCEPT { return 4; }
        ...
        static SBE_CONSTEXPR std::uint16_t strikePriceId() SBE_NOEXCEPT { return 3; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t strikePriceSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool strikePriceInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t strikePriceEncodingOffset() SBE_NOEXCEPT { return 12; }

        static SBE_CONSTEXPR double strikePriceNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double strikePriceMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double strikePriceMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t strikePriceEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t optionSideId() SBE_NOEXCEPT { return 4; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t optionSideSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool optionSideInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t optionSideEncodingOffset() SBE_NOEXCEPT { return 20; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t optionSideEncodingLength() SBE_NOEXCEPT { return 1; }
        ...
        static SBE_CONSTEXPR std::uint16_t impliedVolId() SBE_NOEXCEPT { return 5; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t impliedVolSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool impliedVolInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t impliedVolEncodingOffset() SBE_NOEXCEPT { return 21; }

        static SBE_CONSTEXPR double impliedVolNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double impliedVolMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double impliedVolMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t impliedVolEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t forwardPriceId() SBE_NOEXCEPT { return 6; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t forwardPriceSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool forwardPriceInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t forwardPriceEncodingOffset() SBE_NOEXCEPT { return 29; }

        static SBE_CONSTEXPR double forwardPriceNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double forwardPriceMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double forwardPriceMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t forwardPriceEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t timeToExpiryId() SBE_NOEXCEPT { return 7; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t timeToExpirySinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool timeToExpiryInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t timeToExpiryEncodingOffset() SBE_NOEXCEPT { return 37; }

        static SBE_CONSTEXPR double timeToExpiryNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double timeToExpiryMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double timeToExpiryMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t timeToExpiryEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t bidIvId() SBE_NOEXCEPT { return 8; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t bidIvSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool bidIvInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t bidIvEncodingOffset() SBE_NOEXCEPT { return 45; }

        static SBE_CONSTEXPR double bidIvNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double bidIvMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double bidIvMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t bidIvEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t askIvId() SBE_NOEXCEPT { return 9; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t askIvSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool askIvInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t askIvEncodingOffset() SBE_NOEXCEPT { return 53; }

        static SBE_CONSTEXPR double askIvNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double askIvMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double askIvMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t askIvEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t bidPriceId() SBE_NOEXCEPT { return 10; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t bidPriceEncodingOffset() SBE_NOEXCEPT { return 61; }
        ...
        static SBE_CONSTEXPR std::uint16_t askPriceId() SBE_NOEXCEPT { return 11; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t askPriceEncodingOffset() SBE_NOEXCEPT { return 69; }
        ...
        static SBE_CONSTEXPR std::uint16_t deltaId() SBE_NOEXCEPT { return 12; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t deltaSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool deltaInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t deltaEncodingOffset() SBE_NOEXCEPT { return 77; }

        static SBE_CONSTEXPR double deltaNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double deltaMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double deltaMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t deltaEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t gammaId() SBE_NOEXCEPT { return 13; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t gammaSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool gammaInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t gammaEncodingOffset() SBE_NOEXCEPT { return 85; }

        static SBE_CONSTEXPR double gammaNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double gammaMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double gammaMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t gammaEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t vegaId() SBE_NOEXCEPT { return 14; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t vegaSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool vegaInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t vegaEncodingOffset() SBE_NOEXCEPT { return 93; }

        static SBE_CONSTEXPR double vegaNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double vegaMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double vegaMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t vegaEncodingLength() SBE_NOEXCEPT { return 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t thetaId() SBE_NOEXCEPT { return 15; }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t thetaSinceVersion() SBE_NOEXCEPT { return 0; }

        SBE_NODISCARD bool thetaInActingVersion() SBE_NOEXCEPT { return true; }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t thetaEncodingOffset() SBE_NOEXCEPT { return 101; }

        static SBE_CONSTEXPR double thetaNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

        static SBE_CONSTEXPR double thetaMinValue() SBE_NOEXCEPT { return 4.9E-324; }

        static SBE_CONSTEXPR double thetaMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

        static SBE_CONSTEXPR std::size_t thetaEncodingLength() SBE_NOEXCEPT { return 8; }
...
public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t pointsId() SBE_NOEXCEPT { return 5; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t pointsSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool pointsInActingVersion() const SBE_NOEXCEPT { return true; }

    template <typename CharT, typename Traits>
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const VolSurface& _writer) {
        VolSurface writer(_writer.m_buffer,
                          _writer.m_offset,
        ...
        builder << '"' << writer.getUnderlyingAsJsonEscapedString().c_str() << '"';
        ...
        builder << ", ";
        {
            ...
            builder << R"("points": [)";
            writer.points().forEach([&](Points& points) {
                if (atLeastOne) {
                    builder << ", ";
                }
                atLeastOne = true;
