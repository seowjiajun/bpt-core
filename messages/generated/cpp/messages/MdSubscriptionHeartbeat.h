...
#ifndef _BPT_MESSAGES_MDSUBSCRIPTIONHEARTBEAT_CXX_H_
#define _BPT_MESSAGES_MDSUBSCRIPTIONHEARTBEAT_CXX_H_
...
public:
    ...
    MdSubscriptionHeartbeat() = default;
    ...
    MdSubscriptionHeartbeat(char *buffer, const std::uint64_t bufferLength) :
        MdSubscriptionHeartbeat(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MdSubscriptionHeartbeat(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MdSubscriptionHeartbeat(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MdSubscriptionHeartbeat &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MdSubscriptionHeartbeat &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MdSubscriptionHeartbeat &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MdSubscriptionHeartbeat &sbeRewind()
    {
    ...
    {
        MdSubscriptionHeartbeat skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    MdSubscriptionHeartbeat &timestampNs(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    MdSubscriptionHeartbeat &instrumentId(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    MdSubscriptionHeartbeat &seqNum(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MdSubscriptionHeartbeat &_writer)
{
    MdSubscriptionHeartbeat writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MdSubscriptionHeartbeat", )";
