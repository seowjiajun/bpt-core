...
#ifndef _BIFROST_PROTOCOL_MDSUBSCRIPTIONHEARTBEAT_CXX_H_
#define _BIFROST_PROTOCOL_MDSUBSCRIPTIONHEARTBEAT_CXX_H_
...
public:
    ...
    MdSubscriptionHeartbeat(char* buffer,
    ...
    MdSubscriptionHeartbeat& wrapAndApplyHeader(char* buffer,
                                                const std::uint64_t offset,
                                                const std::uint64_t bufferLength) {
    ...
    MdSubscriptionHeartbeat& wrapForDecode(char* buffer,
                                           const std::uint64_t offset,
                                           const std::uint64_t actingBlockLength,
                                           const std::uint64_t actingVersion,
                                           const std::uint64_t bufferLength) {
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const MdSubscriptionHeartbeat& _writer) {
        MdSubscriptionHeartbeat writer(_writer.m_buffer,
                                       _writer.m_offset,
