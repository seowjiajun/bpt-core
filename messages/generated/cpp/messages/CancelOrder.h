...
#ifndef _BIFROST_PROTOCOL_CANCELORDER_CXX_H_
#define _BIFROST_PROTOCOL_CANCELORDER_CXX_H_
...
public:
    ...
    CancelOrder(char* buffer, const std::uint64_t bufferLength)
    ...
    CancelOrder& wrapForEncode(char* buffer, const std::uint64_t offset, const std::uint64_t bufferLength) {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    CancelOrder& wrapAndApplyHeader(char* buffer, const std::uint64_t offset, const std::uint64_t bufferLength) {
    ...
    CancelOrder& wrapForDecode(char* buffer,
                               const std::uint64_t offset,
                               const std::uint64_t actingBlockLength,
                               const std::uint64_t actingVersion,
                               const std::uint64_t bufferLength) {
    ...
    SBE_NODISCARD std::uint64_t decodeLength() const {
        CancelOrder skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    CancelOrder& orderId(const std::uint64_t value) SBE_NOEXCEPT {
    ...
    CancelOrder& exchangeId(const ExchangeId::Value value) SBE_NOEXCEPT {
    ...
    CancelOrder& instrumentId(const std::uint64_t value) SBE_NOEXCEPT {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    static SBE_CONSTEXPR std::uint16_t timestampNsId() SBE_NOEXCEPT { return 4; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t timestampNsEncodingOffset() SBE_NOEXCEPT { return 17; }
    ...
    CancelOrder& timestampNs(const std::uint64_t value) SBE_NOEXCEPT {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
        ...
        CancelOrder writer(_writer.m_buffer,
                           _writer.m_offset,
