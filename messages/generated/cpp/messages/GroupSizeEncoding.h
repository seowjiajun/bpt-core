...
#ifndef _BIFROST_PROTOCOL_GROUPSIZEENCODING_CXX_H_
#define _BIFROST_PROTOCOL_GROUPSIZEENCODING_CXX_H_
...
public:
    ...
    GroupSizeEncoding& wrap(char* buffer,
                            const std::uint64_t offset,
                            const std::uint64_t actingVersion,
                            const std::uint64_t bufferLength) {
        m_buffer = buffer;
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t encodedLength() SBE_NOEXCEPT { return 4; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t numInGroupSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool numInGroupInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t numInGroupEncodingOffset() SBE_NOEXCEPT { return 2; }

    static SBE_CONSTEXPR std::uint16_t numInGroupNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT16; }

    static SBE_CONSTEXPR std::uint16_t numInGroupMinValue() SBE_NOEXCEPT { return static_cast<std::uint16_t>(0); }

    static SBE_CONSTEXPR std::uint16_t numInGroupMaxValue() SBE_NOEXCEPT { return static_cast<std::uint16_t>(65534); }

    static SBE_CONSTEXPR std::size_t numInGroupEncodingLength() SBE_NOEXCEPT { return 2; }
