...
#ifndef _BIFROST_PROTOCOL_REFDATASNAPSHOT_CXX_H_
#define _BIFROST_PROTOCOL_REFDATASNAPSHOT_CXX_H_
...
public:
    ...
    RefDataSnapshot& wrapForDecode(char* buffer,
                                   const std::uint64_t offset,
                                   const std::uint64_t actingBlockLength,
                                   const std::uint64_t actingVersion,
                                   const std::uint64_t bufferLength) {
    ...
    static SBE_CONSTEXPR std::uint16_t snapshotSeqNumId() SBE_NOEXCEPT { return 2; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t snapshotSeqNumSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool snapshotSeqNumInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t snapshotSeqNumEncodingOffset() SBE_NOEXCEPT { return 8; }

    static SBE_CONSTEXPR std::uint64_t snapshotSeqNumNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT64; }

    static SBE_CONSTEXPR std::uint64_t snapshotSeqNumMinValue() SBE_NOEXCEPT { return UINT64_C(0x0); }

    static SBE_CONSTEXPR std::uint64_t snapshotSeqNumMaxValue() SBE_NOEXCEPT { return UINT64_C(0xfffffffffffffffe); }

    static SBE_CONSTEXPR std::size_t snapshotSeqNumEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t timestampNsEncodingOffset() SBE_NOEXCEPT { return 16; }
...
#pragma GCC diagnostic pop
        ...
        static SBE_CONSTEXPR std::uint64_t sbeBlockLength() SBE_NOEXCEPT { return 119; }
        ...
        static SBE_CONSTEXPR std::uint16_t symbolId() SBE_NOEXCEPT { return 2; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t symbolEncodingOffset() SBE_NOEXCEPT { return 8; }
        ...
        SBE_NODISCARD const char* symbol() const SBE_NOEXCEPT { return m_buffer + m_offset + 8; }

        SBE_NODISCARD char* symbol() SBE_NOEXCEPT { return m_buffer + m_offset + 8; }
        ...
        static SBE_CONSTEXPR std::uint16_t exchangeId() SBE_NOEXCEPT { return 3; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t exchangeEncodingOffset() SBE_NOEXCEPT { return 32; }
        ...
        SBE_NODISCARD const char* exchange() const SBE_NOEXCEPT { return m_buffer + m_offset + 32; }

        SBE_NODISCARD char* exchange() SBE_NOEXCEPT { return m_buffer + m_offset + 32; }
        ...
        static SBE_CONSTEXPR std::uint16_t baseCurrencyId() SBE_NOEXCEPT { return 4; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t baseCurrencyEncodingOffset() SBE_NOEXCEPT { return 40; }
        ...
        SBE_NODISCARD const char* baseCurrency() const SBE_NOEXCEPT { return m_buffer + m_offset + 40; }

        SBE_NODISCARD char* baseCurrency() SBE_NOEXCEPT { return m_buffer + m_offset + 40; }
        ...
        static SBE_CONSTEXPR std::uint16_t quoteCurrencyId() SBE_NOEXCEPT { return 5; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t quoteCurrencyEncodingOffset() SBE_NOEXCEPT { return 48; }
        ...
        SBE_NODISCARD const char* quoteCurrency() const SBE_NOEXCEPT { return m_buffer + m_offset + 48; }

        SBE_NODISCARD char* quoteCurrency() SBE_NOEXCEPT { return m_buffer + m_offset + 48; }
        ...
        static SBE_CONSTEXPR std::uint16_t instrumentTypeId() SBE_NOEXCEPT { return 6; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t instrumentTypeEncodingOffset() SBE_NOEXCEPT { return 56; }
        ...
        static SBE_CONSTEXPR std::uint16_t statusId() SBE_NOEXCEPT { return 7; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t statusEncodingOffset() SBE_NOEXCEPT { return 57; }
        ...
        static SBE_CONSTEXPR std::uint16_t lotSizeId() SBE_NOEXCEPT { return 8; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t lotSizeEncodingOffset() SBE_NOEXCEPT { return 58; }
        ...
        static SBE_CONSTEXPR std::uint16_t tickSizeId() SBE_NOEXCEPT { return 9; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t tickSizeEncodingOffset() SBE_NOEXCEPT { return 66; }
        ...
        static SBE_CONSTEXPR std::uint16_t contractSizeId() SBE_NOEXCEPT { return 10; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t contractSizeEncodingOffset() SBE_NOEXCEPT { return 74; }
        ...
        static SBE_CONSTEXPR std::uint16_t expiryDateId() SBE_NOEXCEPT { return 11; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t expiryDateEncodingOffset() SBE_NOEXCEPT { return 82; }
        ...
        static SBE_CONSTEXPR std::uint16_t underlyingId() SBE_NOEXCEPT { return 12; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t underlyingEncodingOffset() SBE_NOEXCEPT { return 86; }
        ...
        SBE_NODISCARD const char* underlying() const SBE_NOEXCEPT { return m_buffer + m_offset + 86; }

        SBE_NODISCARD char* underlying() SBE_NOEXCEPT { return m_buffer + m_offset + 86; }
        ...
        static SBE_CONSTEXPR std::uint16_t optionSideId() SBE_NOEXCEPT { return 13; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t optionSideEncodingOffset() SBE_NOEXCEPT { return 110; }
        ...
        static SBE_CONSTEXPR std::uint16_t strikePriceId() SBE_NOEXCEPT { return 14; }
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t strikePriceEncodingOffset() SBE_NOEXCEPT { return 111; }
...
public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t instrumentsId() SBE_NOEXCEPT { return 4; }
    ...
    template <typename CharT, typename Traits>
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const RefDataSnapshot& _writer) {
        RefDataSnapshot writer(_writer.m_buffer,
                               _writer.m_offset,
