...
#ifndef _BPT_MESSAGES_REFDATAREADY_CXX_H_
#define _BPT_MESSAGES_REFDATAREADY_CXX_H_
...
public:
    ...
    static SBE_CONSTEXPR std::uint16_t instrumentCountNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT16;
    }

    static SBE_CONSTEXPR std::uint16_t instrumentCountMinValue() SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::uint16_t feeSchedulesLoadedId() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t feeSchedulesLoadedSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool feeSchedulesLoadedInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t feeSchedulesLoadedEncodingOffset() SBE_NOEXCEPT
    {
        return 11;
    }

    static SBE_CONSTEXPR std::uint8_t feeSchedulesLoadedNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT8;
    }

    static SBE_CONSTEXPR std::uint8_t feeSchedulesLoadedMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }
    ...
    static SBE_CONSTEXPR std::size_t feeSchedulesLoadedEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
    ...
    static SBE_CONSTEXPR std::uint16_t fundingRatesLoadedId() SBE_NOEXCEPT
    {
        return 5;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t fundingRatesLoadedSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool fundingRatesLoadedInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t fundingRatesLoadedEncodingOffset() SBE_NOEXCEPT
    {
        return 12;
    }

    static SBE_CONSTEXPR std::uint8_t fundingRatesLoadedNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT8;
    }

    static SBE_CONSTEXPR std::uint8_t fundingRatesLoadedMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }
    ...
    static SBE_CONSTEXPR std::size_t fundingRatesLoadedEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const RefDataReady &_writer)
{
    RefDataReady writer(
        _writer.m_buffer,
        _writer.m_offset,
