...
#ifndef _BIFROST_PROTOCOL_REFDATADELTA_CXX_H_
#define _BIFROST_PROTOCOL_REFDATADELTA_CXX_H_
...
public:
    ...
    RefDataDelta& wrapForDecode(char* buffer,
                                const std::uint64_t offset,
                                const std::uint64_t actingBlockLength,
                                const std::uint64_t actingVersion,
                                const std::uint64_t bufferLength) {
    ...
    static SBE_CONSTEXPR std::uint16_t deltaSeqNumId() SBE_NOEXCEPT { return 1; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t deltaSeqNumSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool deltaSeqNumInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t deltaSeqNumEncodingOffset() SBE_NOEXCEPT { return 0; }

    static SBE_CONSTEXPR std::uint64_t deltaSeqNumNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT64; }

    static SBE_CONSTEXPR std::uint64_t deltaSeqNumMinValue() SBE_NOEXCEPT { return UINT64_C(0x0); }

    static SBE_CONSTEXPR std::uint64_t deltaSeqNumMaxValue() SBE_NOEXCEPT { return UINT64_C(0xfffffffffffffffe); }

    static SBE_CONSTEXPR std::size_t deltaSeqNumEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    static SBE_CONSTEXPR std::uint16_t updateTypeId() SBE_NOEXCEPT { return 3; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t updateTypeSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool updateTypeInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t updateTypeEncodingOffset() SBE_NOEXCEPT { return 16; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t updateTypeEncodingLength() SBE_NOEXCEPT { return 1; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t symbolEncodingOffset() SBE_NOEXCEPT { return 25; }
    ...
    SBE_NODISCARD const char* symbol() const SBE_NOEXCEPT { return m_buffer + m_offset + 25; }

    SBE_NODISCARD char* symbol() SBE_NOEXCEPT { return m_buffer + m_offset + 25; }
    ...
    static SBE_CONSTEXPR std::uint16_t exchangeId() SBE_NOEXCEPT { return 6; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t exchangeEncodingOffset() SBE_NOEXCEPT { return 49; }
    ...
    SBE_NODISCARD const char* exchange() const SBE_NOEXCEPT { return m_buffer + m_offset + 49; }

    SBE_NODISCARD char* exchange() SBE_NOEXCEPT { return m_buffer + m_offset + 49; }
    ...
    static SBE_CONSTEXPR std::uint16_t baseCurrencyId() SBE_NOEXCEPT { return 7; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t baseCurrencyEncodingOffset() SBE_NOEXCEPT { return 57; }
    ...
    SBE_NODISCARD const char* baseCurrency() const SBE_NOEXCEPT { return m_buffer + m_offset + 57; }

    SBE_NODISCARD char* baseCurrency() SBE_NOEXCEPT { return m_buffer + m_offset + 57; }
    ...
    static SBE_CONSTEXPR std::uint16_t quoteCurrencyId() SBE_NOEXCEPT { return 8; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t quoteCurrencyEncodingOffset() SBE_NOEXCEPT { return 65; }
    ...
    SBE_NODISCARD const char* quoteCurrency() const SBE_NOEXCEPT { return m_buffer + m_offset + 65; }

    SBE_NODISCARD char* quoteCurrency() SBE_NOEXCEPT { return m_buffer + m_offset + 65; }
    ...
    static SBE_CONSTEXPR std::uint16_t instrumentTypeId() SBE_NOEXCEPT { return 9; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t instrumentTypeEncodingOffset() SBE_NOEXCEPT { return 73; }
    ...
    static SBE_CONSTEXPR std::uint16_t statusId() SBE_NOEXCEPT { return 10; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t statusEncodingOffset() SBE_NOEXCEPT { return 74; }
    ...
    static SBE_CONSTEXPR std::uint16_t lotSizeId() SBE_NOEXCEPT { return 11; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t lotSizeSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool lotSizeInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t lotSizeEncodingOffset() SBE_NOEXCEPT { return 75; }

    static SBE_CONSTEXPR double lotSizeNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double lotSizeMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double lotSizeMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t lotSizeEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    static SBE_CONSTEXPR std::uint16_t tickSizeId() SBE_NOEXCEPT { return 12; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t tickSizeSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool tickSizeInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t tickSizeEncodingOffset() SBE_NOEXCEPT { return 83; }

    static SBE_CONSTEXPR double tickSizeNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double tickSizeMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double tickSizeMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t tickSizeEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    static SBE_CONSTEXPR std::uint16_t contractSizeId() SBE_NOEXCEPT { return 13; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t contractSizeSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool contractSizeInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t contractSizeEncodingOffset() SBE_NOEXCEPT { return 91; }

    static SBE_CONSTEXPR double contractSizeNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double contractSizeMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double contractSizeMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t contractSizeEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    static SBE_CONSTEXPR std::uint16_t expiryDateId() SBE_NOEXCEPT { return 14; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t expiryDateEncodingOffset() SBE_NOEXCEPT { return 99; }
    ...
    static SBE_CONSTEXPR std::uint16_t underlyingId() SBE_NOEXCEPT { return 15; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t underlyingEncodingOffset() SBE_NOEXCEPT { return 103; }
    ...
    SBE_NODISCARD const char* underlying() const SBE_NOEXCEPT { return m_buffer + m_offset + 103; }

    SBE_NODISCARD char* underlying() SBE_NOEXCEPT { return m_buffer + m_offset + 103; }
    ...
    static SBE_CONSTEXPR std::uint16_t optionSideId() SBE_NOEXCEPT { return 16; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t optionSideEncodingOffset() SBE_NOEXCEPT { return 127; }
    ...
    static SBE_CONSTEXPR std::uint16_t strikePriceId() SBE_NOEXCEPT { return 17; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t strikePriceEncodingOffset() SBE_NOEXCEPT { return 128; }
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const RefDataDelta& _writer) {
        RefDataDelta writer(_writer.m_buffer,
                            _writer.m_offset,
