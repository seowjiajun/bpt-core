...
#ifndef _BIFROST_PROTOCOL_PRICERREADY_CXX_H_
#define _BIFROST_PROTOCOL_PRICERREADY_CXX_H_
...
public:
    ...
    PricerReady& wrapForDecode(char* buffer,
                              const std::uint64_t offset,
                              const std::uint64_t actingBlockLength,
                              const std::uint64_t actingVersion,
                              const std::uint64_t bufferLength) {
    ...
    static SBE_CONSTEXPR std::uint16_t underlyingCountId() SBE_NOEXCEPT { return 3; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t underlyingCountSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool underlyingCountInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t underlyingCountEncodingOffset() SBE_NOEXCEPT { return 9; }

    static SBE_CONSTEXPR std::uint16_t underlyingCountNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT16; }

    static SBE_CONSTEXPR std::uint16_t underlyingCountMinValue() SBE_NOEXCEPT { return static_cast<std::uint16_t>(0); }

    static SBE_CONSTEXPR std::uint16_t underlyingCountMaxValue() SBE_NOEXCEPT {
        return static_cast<std::uint16_t>(65534);
    }

    static SBE_CONSTEXPR std::size_t underlyingCountEncodingLength() SBE_NOEXCEPT { return 2; }
    ...
    static SBE_CONSTEXPR std::uint16_t pointCountId() SBE_NOEXCEPT { return 4; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t pointCountSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool pointCountInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t pointCountEncodingOffset() SBE_NOEXCEPT { return 11; }

    static SBE_CONSTEXPR std::uint32_t pointCountNullValue() SBE_NOEXCEPT { return SBE_NULLVALUE_UINT32; }

    static SBE_CONSTEXPR std::uint32_t pointCountMinValue() SBE_NOEXCEPT { return UINT32_C(0x0); }

    static SBE_CONSTEXPR std::uint32_t pointCountMaxValue() SBE_NOEXCEPT { return UINT32_C(0xfffffffe); }

    static SBE_CONSTEXPR std::size_t pointCountEncodingLength() SBE_NOEXCEPT { return 4; }
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const PricerReady& _writer) {
        PricerReady writer(_writer.m_buffer,
                          _writer.m_offset,
