...
#ifndef _BPT_MESSAGES_MDMARKETDATA_CXX_H_
#define _BPT_MESSAGES_MDMARKETDATA_CXX_H_
...
public:
    ...
    static SBE_CONSTEXPR double askQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_DOUBLE_NAN;
    }

    static SBE_CONSTEXPR double askQtyMinValue() SBE_NOEXCEPT
    {
        return 4.9E-324;
    }

    static SBE_CONSTEXPR double askQtyMaxValue() SBE_NOEXCEPT
    {
        return 1.7976931348623157E308;
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MdMarketData &_writer)
{
    MdMarketData writer(
        _writer.m_buffer,
        _writer.m_offset,
