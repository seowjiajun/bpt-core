...
public:
    ...
    static SBE_CONSTEXPR double qtyNullValue() SBE_NOEXCEPT
    {
        return SBE_DOUBLE_NAN;
    }

    static SBE_CONSTEXPR double qtyMinValue() SBE_NOEXCEPT
    {
        return 4.9E-324;
    }

    static SBE_CONSTEXPR double qtyMaxValue() SBE_NOEXCEPT
    {
        return 1.7976931348623157E308;
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MdTrade &_writer)
{
    MdTrade writer(
        _writer.m_buffer,
        _writer.m_offset,
