...
#ifndef _BPT_MESSAGES_MDORDERBOOK_CXX_H_
#define _BPT_MESSAGES_MDORDERBOOK_CXX_H_
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MdOrderBook &_writer)
{
    MdOrderBook writer(
        _writer.m_buffer,
        _writer.m_offset,
