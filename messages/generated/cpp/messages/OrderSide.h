...
#ifndef _BIFROST_PROTOCOL_ORDERSIDE_CXX_H_
#define _BIFROST_PROTOCOL_ORDERSIDE_CXX_H_
...
public:
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& os, OrderSide::Value m) {
