...
#ifndef _BPT_MESSAGES_BACKTESTCONTROL_CXX_H_
#define _BPT_MESSAGES_BACKTESTCONTROL_CXX_H_
...
public:
    ...
    static SBE_CONSTEXPR std::uint16_t commandId() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t commandSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool commandInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t commandEncodingOffset() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t commandEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const BacktestControl &_writer)
{
    BacktestControl writer(
        _writer.m_buffer,
        _writer.m_offset,
