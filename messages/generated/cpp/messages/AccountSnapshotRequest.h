...
#ifndef _BPT_MESSAGES_ACCOUNTSNAPSHOTREQUEST_CXX_H_
#define _BPT_MESSAGES_ACCOUNTSNAPSHOTREQUEST_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(26);
    ...
    AccountSnapshotRequest() = default;
    ...
    AccountSnapshotRequest(char *buffer, const std::uint64_t bufferLength) :
        AccountSnapshotRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    AccountSnapshotRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        AccountSnapshotRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    AccountSnapshotRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    AccountSnapshotRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    AccountSnapshotRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    AccountSnapshotRequest &sbeRewind()
    {
    ...
    {
        AccountSnapshotRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    AccountSnapshotRequest &exchangeId(const ExchangeId::Value value) SBE_NOEXCEPT
    {
    ...
    AccountSnapshotRequest &correlationId(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    AccountSnapshotRequest &timestampNs(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const AccountSnapshotRequest &_writer)
{
    AccountSnapshotRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "AccountSnapshotRequest", )";
