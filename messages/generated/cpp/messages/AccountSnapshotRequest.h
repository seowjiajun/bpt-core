...
#ifndef _BIFROST_PROTOCOL_ACCOUNTSNAPSHOTREQUEST_CXX_H_
#define _BIFROST_PROTOCOL_ACCOUNTSNAPSHOTREQUEST_CXX_H_
...
public:
    ...
    AccountSnapshotRequest(char* buffer,
    ...
    AccountSnapshotRequest& wrapAndApplyHeader(char* buffer,
                                               const std::uint64_t offset,
                                               const std::uint64_t bufferLength) {
    ...
    AccountSnapshotRequest& wrapForDecode(char* buffer,
                                          const std::uint64_t offset,
                                          const std::uint64_t actingBlockLength,
                                          const std::uint64_t actingVersion,
                                          const std::uint64_t bufferLength) {
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const AccountSnapshotRequest& _writer) {
        AccountSnapshotRequest writer(_writer.m_buffer,
                                      _writer.m_offset,
