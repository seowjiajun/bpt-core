...
#ifndef _BPT_MESSAGES_INSTRUMENTSTATS_CXX_H_
#define _BPT_MESSAGES_INSTRUMENTSTATS_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(57);
    ...
    InstrumentStats(char* buffer, const std::uint64_t bufferLength)
        : InstrumentStats(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion()) {}

    InstrumentStats(char* buffer,
                    const std::uint64_t bufferLength,
                    const std::uint64_t actingBlockLength,
                    const std::uint64_t actingVersion)
        : InstrumentStats(buffer, 0, bufferLength, actingBlockLength, actingVersion) {}
    ...
    InstrumentStats& wrapForEncode(char* buffer, const std::uint64_t offset, const std::uint64_t bufferLength) {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    InstrumentStats& wrapAndApplyHeader(char* buffer, const std::uint64_t offset, const std::uint64_t bufferLength) {
    ...
    InstrumentStats& wrapForDecode(char* buffer,
                                   const std::uint64_t offset,
                                   const std::uint64_t actingBlockLength,
                                   const std::uint64_t actingVersion,
                                   const std::uint64_t bufferLength) {
    ...
    SBE_NODISCARD std::uint64_t decodeLength() const {
        InstrumentStats skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    InstrumentStats& exchangeId(const ExchangeId::Value value) SBE_NOEXCEPT {
    ...
    InstrumentStats& instrumentId(const std::uint64_t value) SBE_NOEXCEPT {
    ...
    static SBE_CONSTEXPR std::uint16_t openInterestId() SBE_NOEXCEPT { return 3; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t openInterestSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool openInterestInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t openInterestEncodingOffset() SBE_NOEXCEPT { return 9; }

    static SBE_CONSTEXPR double openInterestNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double openInterestMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double openInterestMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t openInterestEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    InstrumentStats& openInterest(const double value) SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
    ...
    SBE_NODISCARD static const char* volume24hMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT {
        switch (metaAttribute) {
            case MetaAttribute::PRESENCE:
                return "required";
            default:
    ...
    static SBE_CONSTEXPR std::uint16_t volume24hId() SBE_NOEXCEPT { return 4; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t volume24hSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool volume24hInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t volume24hEncodingOffset() SBE_NOEXCEPT { return 17; }

    static SBE_CONSTEXPR double volume24hNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double volume24hMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double volume24hMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t volume24hEncodingLength() SBE_NOEXCEPT { return 8; }

    SBE_NODISCARD double volume24h() const SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        std::memcpy(&val, m_buffer + m_offset + 17, sizeof(double));
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
        return val.fp_value;
    }

    InstrumentStats& volume24h(const double value) SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
        std::memcpy(m_buffer + m_offset + 17, &val, sizeof(double));
        return *this;
    }
    ...
    static SBE_CONSTEXPR std::uint16_t markPriceId() SBE_NOEXCEPT { return 5; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t markPriceSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool markPriceInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t markPriceEncodingOffset() SBE_NOEXCEPT { return 25; }

    static SBE_CONSTEXPR double markPriceNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double markPriceMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double markPriceMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t markPriceEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    InstrumentStats& markPrice(const double value) SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
    ...
    static SBE_CONSTEXPR std::uint16_t indexPriceId() SBE_NOEXCEPT { return 6; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t indexPriceSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool indexPriceInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t indexPriceEncodingOffset() SBE_NOEXCEPT { return 33; }

    static SBE_CONSTEXPR double indexPriceNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double indexPriceMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double indexPriceMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t indexPriceEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    InstrumentStats& indexPrice(const double value) SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
    ...
    static SBE_CONSTEXPR std::uint16_t lastPriceId() SBE_NOEXCEPT { return 7; }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t lastPriceSinceVersion() SBE_NOEXCEPT { return 0; }

    SBE_NODISCARD bool lastPriceInActingVersion() SBE_NOEXCEPT { return true; }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t lastPriceEncodingOffset() SBE_NOEXCEPT { return 41; }

    static SBE_CONSTEXPR double lastPriceNullValue() SBE_NOEXCEPT { return SBE_DOUBLE_NAN; }

    static SBE_CONSTEXPR double lastPriceMinValue() SBE_NOEXCEPT { return 4.9E-324; }

    static SBE_CONSTEXPR double lastPriceMaxValue() SBE_NOEXCEPT { return 1.7976931348623157E308; }

    static SBE_CONSTEXPR std::size_t lastPriceEncodingLength() SBE_NOEXCEPT { return 8; }
    ...
    InstrumentStats& lastPrice(const double value) SBE_NOEXCEPT {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
    ...
    static SBE_CONSTEXPR std::uint16_t collectedTsId() SBE_NOEXCEPT { return 8; }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t collectedTsEncodingOffset() SBE_NOEXCEPT { return 49; }
    ...
    InstrumentStats& collectedTs(const std::uint64_t value) SBE_NOEXCEPT {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& builder,
                                                         const InstrumentStats& _writer) {
        InstrumentStats writer(_writer.m_buffer,
                               _writer.m_offset,
        ...
        builder << '{';
        builder << R"("Name": "InstrumentStats", )";
