...
InstrumentType from_sbe_type(bpt::messages::InstrumentType::Value v) {
...
InstrumentStatus from_sbe_status(bpt::messages::InstrumentStatus::Value v) {
...
OptionSide from_sbe_option_side(bpt::messages::OptionSide::Value v) {
    using P = bpt::messages::OptionSide;
    switch (v) {
        case P::CALL:
...
void InstrumentCache::apply_snapshot(bpt::messages::RefDataSnapshot& msg) {
    cache_.clear();
...
bool InstrumentCache::apply_delta(bpt::messages::RefDataDelta& msg) {
    using DUT = bpt::messages::DeltaUpdateType;
