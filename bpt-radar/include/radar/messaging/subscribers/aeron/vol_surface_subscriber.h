...
public:
    VolSurfaceSubscriber(std::shared_ptr<::aeron::Aeron> aeron, const bpt::common::config::StreamConfig& stream) {
        ...
        bpt::common::log::info("[VolSurfaceSubscriber] ready on stream {}", stream.stream_id);
    }
